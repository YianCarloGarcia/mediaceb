...
# Cloudinary config
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'disfdzezg',
    'API_KEY': '191245294769166',
    'API_SECRET': 'NEMepN9OeBkHhm7TrnXBf-dUFAc',
}

# Reemplazar el DEFAULT_FILE_STORAGE
DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'
# ── Autenticación ─────────────────────────────────────────────────────────────
LOGIN_URL          = '/login/'          # Redirige aquí si no está autenticado
LOGIN_REDIRECT_URL = '/estudiantes/'    # Redirige aquí después del login
...
MIDDLEWARE.insert(1, 'whitenoise.middleware.WhiteNoiseSMiddleware')
